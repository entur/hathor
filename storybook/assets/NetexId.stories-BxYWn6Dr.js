import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{N as n,at as r,dt as i,ht as a,in as o,j as s,kt as c,lt as l,o as u,r as d,t as f}from"./iframe-D7q1UzBu.js";import{i as p,n as m,r as h,t as g}from"./ContentCopy-H0xkEc5z.js";function _(e){let t=e.split(C);return t.length>=3?{code:t[0]||w,type:t[1]||w,value:t.slice(2).join(C)}:t.length===2?{code:w,type:t[0]||w,value:t[1]}:{code:w,type:w,value:t[0]??``}}function v({id:e,version:t,copy:i=`hide`,size:o=`medium`,sx:s,variant:c=`outlined`,...u}){let{t:f}=d(),{code:p,type:m,value:v}=_(e),w=E[o],D=i!==`hide`,[O,k]=(0,y.useState)(!1),A=(0,y.useRef)(null);(0,y.useEffect)(()=>()=>{A.current!==null&&window.clearTimeout(A.current)},[]);let j=t=>{t.stopPropagation(),navigator.clipboard.writeText(e),k(!0),A.current!==null&&window.clearTimeout(A.current),A.current=window.setTimeout(()=>k(!1),x)},M=O?f(`netex.copied`,`Copied!`):i===`only`?f(`netex.copyIdWith`,`Copy id {{id}}`,{id:e}):f(`netex.copyId`,`Copy id`);if(i===`only`)return(0,b.jsx)(n,{title:M,children:(0,b.jsx)(a,{size:`small`,onClick:j,className:S,"data-testid":`netex-id-copy`,"aria-label":M,sx:{width:w.btn,height:w.btn,p:0,"& svg":{fontSize:w.icon}},children:O?(0,b.jsx)(h,{fontSize:`inherit`}):(0,b.jsx)(g,{fontSize:`inherit`})})});let N=(0,b.jsxs)(r,{sx:{display:`inline-flex`,alignItems:`center`,gap:w.gap},children:[(0,b.jsxs)(`span`,{children:[`${p}${C}${m}${C}`,(0,b.jsx)(r,{component:`strong`,sx:{fontWeight:700},children:v})]}),t!=null&&(0,b.jsx)(l,{label:`v${t}`,size:`small`,variant:`filled`,"data-testid":`netex-id-version`,sx:{height:w.ver,borderRadius:w.ver/2,fontFamily:`monospace`,fontSize:w.verFont,"& .MuiChip-label":{px:.75}}}),D&&(0,b.jsx)(n,{title:M,children:(0,b.jsx)(a,{size:`small`,onClick:j,className:S,"data-testid":`netex-id-copy`,"aria-label":M,sx:{width:w.btn,height:w.btn,p:0,"& svg":{fontSize:w.icon}},children:O?(0,b.jsx)(h,{fontSize:`inherit`}):(0,b.jsx)(g,{fontSize:`inherit`})})})]}),P=i===`onHover`?{[`& .${S}`]:{display:`none`},[`&:hover .${S}, &:focus-within .${S}`]:{display:`inline-flex`}}:{};return(0,b.jsx)(l,{label:N,variant:c,"data-testid":`netex-id`,sx:{height:w.outer,borderRadius:w.outer/T,fontFamily:`monospace`,fontSize:w.idFont,maxWidth:`100%`,"& .MuiChip-label":{display:`flex`,alignItems:`center`},...P,...s},...u})}var y,b,x,S,C,w,T,E,D=e((()=>{y=t(o(),1),u(),m(),p(),f(),b=c(),x=1500,S=`netex-id-copy`,C=`:`,w=`???`,T=3,E={xsmall:{idFont:`0.625rem`,verFont:`0.5rem`,outer:20,ver:13,btn:14,icon:9,gap:.375},small:{idFont:`0.75rem`,verFont:`0.625rem`,outer:24,ver:16,btn:16,icon:11,gap:.5},medium:{idFont:`0.875rem`,verFont:`0.6875rem`,outer:32,ver:20,btn:20,icon:14,gap:.75},large:{idFont:`1rem`,verFont:`0.8125rem`,outer:40,ver:26,btn:26,icon:17,gap:1}},v.__docgenInfo={description:`Read-only chip rendering a NeTEx id, with the optional version surfaced as
a small nested chip (\`vN\`) inside the outer chip. Monospace label for
legibility; outlined outer + filled inner so the version reads as a badge.`,methods:[],displayName:`NetexId`,props:{id:{required:!0,tsType:{name:`string`},description:"Full NeTEx id of the form `CODESPACE:TYPE:VALUE`, e.g. `NMR:Vehicle:abc-123`."},version:{required:!1,tsType:{name:`union`,raw:`string | number`,elements:[{name:`string`},{name:`number`}]},description:"Optional version; rendered as a nested chip labelled `vN`."},copy:{required:!1,tsType:{name:`union`,raw:`'show' | 'hide' | 'onHover' | 'only'`,elements:[{name:`literal`,value:`'show'`},{name:`literal`,value:`'hide'`},{name:`literal`,value:`'onHover'`},{name:`literal`,value:`'only'`}]},description:"Copy-button visibility toggle. Defaults to `'hide'`.",defaultValue:{value:`'hide'`,computed:!1}},size:{required:!1,tsType:{name:`union`,raw:`'xsmall' | 'small' | 'medium' | 'large'`,elements:[{name:`literal`,value:`'xsmall'`},{name:`literal`,value:`'small'`},{name:`literal`,value:`'medium'`},{name:`literal`,value:`'large'`}]},description:"Scales the chip and all sub-elements proportionally. Defaults to `'medium'`.",defaultValue:{value:`'medium'`,computed:!1}},variant:{defaultValue:{value:`'outlined'`,computed:!1},required:!1}},composes:[`Omit`]}})),O,k,A,j,M,N,P,F,I,L,R;e((()=>{u(),D(),O=c(),k=`NSR:VehicleType:6f3a9e`,A=[`xsmall`,`small`,`medium`,`large`],j={title:`data/netex/NetexId`,component:v,parameters:{layout:`centered`,docs:{description:{component:"Read-only chip rendering a NeTEx id (`CODESPACE:TYPE:VALUE`). Optional version chip, tri-state copy button (`hide` / `show` / `onHover` / `only`), and four discrete sizes."}}},argTypes:{id:{control:`text`},version:{control:`text`},size:{control:`select`,options:A},copy:{control:`inline-radio`,options:[`hide`,`show`,`onHover`,`only`],description:"Copy-button visibility. `only` drops the chip entirely."},variant:{control:`inline-radio`,options:[`outlined`,`filled`]}}},M={args:{id:k,size:`medium`,copy:`show`,variant:`outlined`}},N={args:{id:k,copy:`onHover`}},P={args:{id:k,copy:`only`}},F={args:{id:k,version:3,copy:`show`}},I={args:{id:`abc-123`,copy:`hide`}},L={render:()=>(0,O.jsx)(s,{spacing:2,sx:{alignItems:`flex-start`},children:A.map(e=>(0,O.jsxs)(r,{sx:{display:`flex`,alignItems:`center`,gap:2},children:[(0,O.jsx)(i,{variant:`caption`,sx:{width:64,fontFamily:`monospace`},children:e}),(0,O.jsx)(v,{id:k,version:3,copy:`show`,size:e})]},e))})},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  args: {
    id: SAMPLE_ID,
    size: 'medium',
    copy: 'show',
